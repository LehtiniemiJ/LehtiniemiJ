...
#
#
#DO NOT USE UNLESS YOU KNOW WHAT YOU ARE LOOKING FOR IN HERE
#
#Original https://github.com/microsoft/mdatp-xplat/blob/master/linux/installation/mde_installer.sh
#
...
install_on_fedora()
{
    ...
    ### Fetch the gpg key ###
    run_quietly "curl -k --tlsv1.2 https://packages.microsoft.com/keys/microsoft.asc > microsoft.asc" "unable to fetch gpg key $?" $ERR_FAILED_REPO_SETUP
